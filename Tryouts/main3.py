...
def count_fingers_raised(rgb_image, detection_result: mp.tasks.vision.HandLandmarkerResult, maxdist, draw):
...
def main():
   ...
   while True:
      ...
      frame, maxdist = count_fingers_raised(frame,hand_landmarker.result, maxdist, draw)
      # display image
